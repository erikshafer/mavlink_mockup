...
public class T5_LogoutUser {
	...
	@Test
	public void test5LogoutErik() throws Exception {
		// open | /mavlink/logout |
		...
		// assertText | css=body | *You have been logged out*
		assertTrue(driver.findElement(By.cssSelector("body")).getText()
		        .matches("^[\\s\\S]*You have been logged out[\\s\\S]*$"));
	}
